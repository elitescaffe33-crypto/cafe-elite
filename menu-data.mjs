...
export const menuData = [
  withCategory(
    ...
    [
      {
        id: "signature-beef-pastrami-baguette",
        sourceId: "baguette-beef-pastrami-cheese",
        priceKey: "baguette-beef-pastrami-cheese",
        ...
        image: "assets/promos/fresh-baguettes.jpg",
        badge: "NEW",
      },
      {
        id: "signature-bolognese-bowl",
        sourceId: "pasta-bolognese-bowl",
        priceKey: "pasta-bolognese-bowl",
        name: "Bolognese Bowl",
      ...
      },
      {
        ...
        description: "A simple cafe classic with a sandwich, coffee and snack.",
      ...
      {
        id: "signature-pumpkin-spice-latte",
        sourceId: "autumn-pumpkin-spice-latte",
        priceKey: "autumn-pumpkin-spice-latte",
        name: "Pumpkin Spice Latte",
        price: MENU_PRICES.autumnDrink,
        description: "Warm, gently spiced and made for cosy days.",
        image: "assets/menu-autumn-lattes.jpg",
        badge: "SEASONAL",
      },
    ],
    { featured: true },
